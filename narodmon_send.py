...
#camera.shutter_speed = 70000 # если снимать в сложных условиях, то можно скорректировать вручную время выдержки
...
camera.capture(str1)
#print(str1)
foto = open(str1, 'rb')  # some file on local disk, ну да, из крона точно /
headers = {}
